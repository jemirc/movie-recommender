...
![tabulate](https://img.shields.io/badge/UI-tabulate-2F7D7E?style=for-the-badge)
![termcolor](https://img.shields.io/badge/Color-termcolor-D17B49?style=for-the-badge)
...
`tabulate`와 `termcolor`는 `third_party/`에 헤더로 포함되어 있어 별도 설치가 필요 없습니다.
...
- `tabulate`로 영화, 사용자, 평점, 추천, 통계 결과를 표 형태로 출력합니다.
- 숫자 컬럼은 오른쪽 정렬하고 한글 텍스트 컬럼은 멀티바이트 폭을 고려해 정렬합니다.
- `termcolor`로 제목, 프롬프트, 성공/안내/확인 메시지 색상을 구분합니다.
